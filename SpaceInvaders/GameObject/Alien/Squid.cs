...
namespace SpaceInvaders
{
    public class Squid : AlienCategory
    {
        ...
        public Squid(GameObject.Name gOName, GameSprite.Name gSeName, float x, float y)
            : base(gOName, gSeName)
        {
            this.SetXY(x, y);
        }
        ...
        public override void VisitMissile(Missile m)
        {
            ...
            //SpriteBatch pSpriteBatch = SpriteBatchMan.Find(SpriteBatch.Name.Aliens);

            //SBNodeMan pSBNodeMan = pSpriteBatch.GetSBNodeMan();
            //pSBNodeMan.Remove(this);

            //GameObject pGameObject = GameObjectMan.Find(GameObject.Name.AlienGroup);
